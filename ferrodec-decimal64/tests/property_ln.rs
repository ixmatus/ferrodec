...
#[test]
fn spot_log2_e() {
    check_log2_at("2.718281828459045");
}
#[test]
fn spot_log2_half() {
    check_log2_at("0.5");
...
fn spot_log2_near_max() {
    check_log2_at("9.999999999999999e384");
}
#[test]
fn spot_log2_random_finite() {
    check_log2_at("123.456789012345");
}
...
fn spot_log10_powers() {
    for p in [1i32, 2, 3, 5, 10, -1, -3, 100, -100, 300] {
        check_log10_at(&format!("1e{p}"));
    }
}
#[test]
fn spot_log10_e() {
    check_log10_at("2.718281828459045");
}
#[test]
fn spot_log10_half() {
    check_log10_at("0.5");
...
fn spot_log10_subnormal() {
    check_log10_at("1e-390");
}
#[test]
fn spot_log10_near_max() {
    check_log10_at("9.999999999999999e384");
}
#[test]
fn spot_log10_random_finite() {
    check_log10_at("123.456789012345");
}
