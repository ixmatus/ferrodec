//! Kani harnesses for `Decimal64::rem_near` (the IEEE 754-2019 §5.3.1
...
//! only. Port of `ferrodec/src/verify/rem.rs` to the 64-bit format.
...
/// on the general path: decimal64's `handle_specials` returns `None`
