...
fn div_finite_by_zero_raises_div_by_zero() {
    ...
    let divisor = if neg_zero_divisor { Decimal64::NEG_ZERO } else { Decimal64::ZERO };
...
fn div_zero_by_zero_invalid() {
    ...
    let a = if za_neg { Decimal64::NEG_ZERO } else { Decimal64::ZERO };
    let b = if zb_neg { Decimal64::NEG_ZERO } else { Decimal64::ZERO };
