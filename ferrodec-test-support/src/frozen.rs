...
pub const BINARY_FUNCS: &[&str] = &["pow", "atan2", "hypot", "atan2pi"];
...
pub const EXPECTED_BUCKETS_P34: &[(&str, &str, usize)] = &[
    ...
    ("exp", "TowardZero", 24),
    ("exp10", "NearestAway", 43),
    ("exp10", "NearestEven", 71),
    ("exp10", "TowardNegative", 35),
    ("exp10", "TowardPositive", 35),
    ("exp10", "TowardZero", 35),
    ("exp10m1", "NearestAway", 43),
    ("exp10m1", "NearestEven", 71),
    ("exp10m1", "TowardNegative", 37),
    ("exp10m1", "TowardPositive", 37),
    ("exp10m1", "TowardZero", 37),
    ("exp2", "NearestEven", 48),
    ("exp2m1", "NearestAway", 43),
    ("exp2m1", "NearestEven", 71),
    ("exp2m1", "TowardNegative", 36),
    ("exp2m1", "TowardPositive", 36),
    ("exp2m1", "TowardZero", 36),
    ("expm1", "NearestAway", 43),
    ("expm1", "NearestEven", 71),
    ("expm1", "TowardNegative", 43),
    ("expm1", "TowardPositive", 43),
    ("expm1", "TowardZero", 43),
    ("ln", "NearestAway", 66),
    ("ln", "NearestEven", 94),
    ...
    ("log10", "TowardZero", 62),
    ("log10p1", "NearestAway", 58),
    ("log10p1", "NearestEven", 86),
    ("log10p1", "TowardNegative", 56),
    ("log10p1", "TowardPositive", 56),
    ("log10p1", "TowardZero", 56),
    ("log2", "NearestEven", 94),
    ("log2p1", "NearestAway", 58),
    ("log2p1", "NearestEven", 86),
    ("log2p1", "TowardNegative", 55),
    ("log2p1", "TowardPositive", 55),
    ("log2p1", "TowardZero", 55),
    ...
    ("hypot", "TowardZero", 30),
    // ADR-0061 Track D D4: the pi-scaled family (fd-4zo.26).
    ("acospi", "NearestAway", 8),
    ("acospi", "NearestEven", 46),
    ("acospi", "TowardNegative", 6),
    ("acospi", "TowardPositive", 6),
    ("acospi", "TowardZero", 6),
    ("asinpi", "NearestAway", 6),
    ("asinpi", "NearestEven", 46),
    ("asinpi", "TowardNegative", 6),
    ("asinpi", "TowardPositive", 6),
    ("asinpi", "TowardZero", 6),
    ("atan2pi", "NearestAway", 50),
    ("atan2pi", "NearestEven", 50),
    ("atan2pi", "TowardNegative", 42),
    ("atan2pi", "TowardPositive", 42),
    ("atan2pi", "TowardZero", 42),
    ("atanpi", "NearestAway", 21),
    ("atanpi", "NearestEven", 49),
    ("atanpi", "TowardNegative", 21),
    ("atanpi", "TowardPositive", 21),
    ("atanpi", "TowardZero", 21),
    ("cospi", "NearestAway", 40),
    ("cospi", "NearestEven", 68),
    ("cospi", "TowardNegative", 40),
    ("cospi", "TowardPositive", 40),
    ("cospi", "TowardZero", 40),
    ("sinpi", "NearestAway", 40),
    ("sinpi", "NearestEven", 68),
    ("sinpi", "TowardNegative", 40),
    ("sinpi", "TowardPositive", 40),
    ("sinpi", "TowardZero", 40),
    ("tanpi", "NearestAway", 40),
    ("tanpi", "NearestEven", 68),
    ("tanpi", "TowardNegative", 40),
    ("tanpi", "TowardPositive", 40),
    ("tanpi", "TowardZero", 40),
];
...
pub const EXPECTED_BUCKETS_P16: &[(&str, &str, usize)] = &[
    ...
    ("exp2m1", "NearestAway", 43),
    ("exp2m1", "NearestEven", 71),
    ("exp2m1", "TowardNegative", 37),
    ("exp2m1", "TowardPositive", 37),
    ("exp2m1", "TowardZero", 37),
    ("expm1", "NearestAway", 43),
    ("expm1", "NearestEven", 71),
    ("expm1", "TowardNegative", 43),
    ("expm1", "TowardPositive", 43),
...
pub const EXPECTED_BUCKETS_P7: &[(&str, &str, usize)] = &[
    ...
    ("exp", "TowardZero", 17),
    ("exp10", "NearestAway", 39),
    ("exp10", "NearestEven", 67),
    ("exp10", "TowardNegative", 33),
    ("exp10", "TowardPositive", 33),
    ("exp10", "TowardZero", 33),
    ("exp10m1", "NearestAway", 39),
    ("exp10m1", "NearestEven", 67),
    ("exp10m1", "TowardNegative", 35),
    ("exp10m1", "TowardPositive", 35),
    ("exp10m1", "TowardZero", 35),
    ("exp2", "NearestEven", 21),
    ("exp2m1", "NearestAway", 41),
    ("exp2m1", "NearestEven", 69),
    ("exp2m1", "TowardNegative", 35),
    ("exp2m1", "TowardPositive", 35),
    ("exp2m1", "TowardZero", 35),
    ("expm1", "NearestAway", 41),
    ("expm1", "NearestEven", 69),
    ("expm1", "TowardNegative", 41),
    ("expm1", "TowardPositive", 41),
    ("expm1", "TowardZero", 41),
    ("ln", "NearestAway", 48),
    ("ln", "NearestEven", 76),
    ...
    ("log10", "TowardZero", 44),
    ("log10p1", "NearestAway", 55),
    ("log10p1", "NearestEven", 83),
    ("log10p1", "TowardNegative", 53),
    ("log10p1", "TowardPositive", 53),
    ("log10p1", "TowardZero", 53),
    ("log2", "NearestEven", 76),
    ("log2p1", "NearestAway", 55),
    ("log2p1", "NearestEven", 83),
    ("log2p1", "TowardNegative", 52),
    ("log2p1", "TowardPositive", 52),
    ("log2p1", "TowardZero", 52),
    ...
    ("atanpi", "TowardPositive", 21),
    ("atanpi", "TowardZero", 21),
    ("cospi", "NearestAway", 36),
    ("cospi", "NearestEven", 64),
    ("cospi", "TowardNegative", 36),
    ("cospi", "TowardPositive", 36),
    ("cospi", "TowardZero", 36),
    ("sinpi", "NearestAway", 36),
    ("sinpi", "NearestEven", 64),
    ("sinpi", "TowardNegative", 36),
    ("sinpi", "TowardPositive", 36),
    ("sinpi", "TowardZero", 36),
    ("tanpi", "NearestAway", 36),
    ("tanpi", "NearestEven", 64),
    ("tanpi", "TowardNegative", 36),
    ("tanpi", "TowardPositive", 36),
    ("tanpi", "TowardZero", 36),
];
