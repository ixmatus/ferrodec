//! Faithful-rounding contract for `Decimal32::cbrt` vs astro-float,
...
//! the full `Decimal32` exponent envelope. The finite path now routes
...
proptest! {
    ...
    /// the full `Decimal32` exponent envelope, for every rounding
    /// direction.
    #[test]
    fn cbrt_random_faithful(
        ...
        // A `Decimal32` with a 7-digit-or-less coefficient, scaled
