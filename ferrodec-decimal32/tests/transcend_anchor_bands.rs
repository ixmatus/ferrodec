...
const EXPECTED: &[(&str, &str, usize)] = &[
    ...
    ("atan", "NearestAway", 6),
    ("atan", "TowardZero", 6),
    ("atan", "TowardPositive", 6),
    ("atan", "TowardNegative", 6),
    ("atanh", "NearestEven", 6),
    ("atanh", "NearestAway", 6),
    ("atanh", "TowardZero", 6),
    ...
    ("sin", "NearestAway", 6),
    ("sin", "TowardZero", 6),
    ("sin", "TowardPositive", 6),
    ("sin", "TowardNegative", 6),
    ("sinh", "NearestEven", 6),
    ("sinh", "NearestAway", 6),
    ("sinh", "TowardZero", 6),
    ("sinh", "TowardPositive", 6),
    ("sinh", "TowardNegative", 6),
    ("tan", "NearestEven", 6),
    ("tan", "NearestAway", 6),
    ("tan", "TowardZero", 6),
    ("tan", "TowardPositive", 6),
    ("tan", "TowardNegative", 6),
    ("tanh", "NearestEven", 6),
    ("tanh", "NearestAway", 6),
    ("tanh", "TowardZero", 6),
    ("tanh", "TowardPositive", 6),
    ("tanh", "TowardNegative", 6),
];
