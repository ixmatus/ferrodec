//! Arb/FLINT frozen hard-to-round vector gate for `Decimal32`
...
//! / MPFR references.
//!
//! Contract. `ferrodec-decimal32` promises *faithful* rounding (≤1
...
fn kernel(func: &str, x: Decimal32) -> Decimal32 {
...
fn frozen_arb_vectors_faithful() {
    ...
    eprintln!(
        "frozen Arb vectors (Decimal32, p{PREC}): {total} checked, \
