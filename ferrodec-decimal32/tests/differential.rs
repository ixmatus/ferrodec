//! Python/libmpdec differential for `Decimal32` (Track 3, plan
...
// IEEE 754-2019 decimal32 interchange parameters (the Python side
...
fn parse(s: &str) -> Option<Decimal32> {
...
fn val_eq(got: Decimal32, py: &str) -> bool {
    if py == "NaN" || py == "sNaN" {
...
fn within_k(got: Decimal32, py: &str, k: u32) -> bool {
