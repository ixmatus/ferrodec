//! Kani harnesses for `Decimal32::{sin, cos, tan, asin, acos, atan,
//! atan2}`.
//!
...
fn acos_special_only_nan_and_infinity() {
    ...
    assert!(Decimal32::ZERO.acos_special_only_for_kani().is_none());
    assert!(Decimal32::NEG_ZERO.acos_special_only_for_kani().is_none());
    assert!(Decimal32::ONE.acos_special_only_for_kani().is_none());
}
...
fn atan_special_only_nan_and_zero() {
    ...
    assert!(Decimal32::INFINITY.atan_special_only_for_kani().is_none());
    assert!(Decimal32::NEG_INFINITY
        .atan_special_only_for_kani()
        .is_none());
    assert!(Decimal32::ONE.atan_special_only_for_kani().is_none());
}
...
fn atan2_nan_ordering_first_operand_wins() {
    ...
    let (r, s) = Decimal32::NAN
        .atan2_special_only_for_kani(Decimal32::SIGNALING_NAN)
