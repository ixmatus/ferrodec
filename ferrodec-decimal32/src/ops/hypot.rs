//! IEEE 754-2019 §9.2 `hypot` for [`Decimal32`].
//!
...
impl Decimal32 {
    ...
    pub fn hypot(self, y: Self, rm: RoundingMode) -> (Self, Status) {
        ferrodec_transcend::hypot::hypot_kernel::<Decimal32>(self, y, rm)
    }
}
...
mod tests {
    ...
    fn infinity_beats_quiet_nan() {
        let (r, st) = Decimal32::INFINITY.hypot(Decimal32::NAN, RoundingMode::NearestEven);
